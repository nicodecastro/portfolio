...
const Hero = () => {
  return (
    <section id="hero" className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 mb-16 md:mb-24">
        ...
        <div className="mt-12 md:mt-20 lg:mt-28">
            ...
            <div className="flex flex-row items-center mt-8 space-x-6">
                <a
                href={userData.socialLinks.twitter}
                className="text-base font-normal text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100"
                target="__blank"
                >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x h-7 w-7" viewBox="0 0 16 16">
                ...
                target="__blank"
                >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-linkedin h-7 w-7" viewBox="0 0 16 16">
                ...
                target="__blank"
                >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-github h-7 w-7" viewBox="0 0 16 16">
